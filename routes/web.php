...
Route::middleware('authenticate:padrao')->prefix('/app')->group(function(){
    ...
    Route::controller(ProviderController::class)->group(function(){
        Route::get('/provider', 'index')->name('app.provider');
        Route::post('/provider/list', 'show')->name('app.provider.list');
        Route::get('/provider/register', 'create')->name('app.provider.register');
        Route::post('/provider/register', 'create')->name('app.provider.register');
    });
